...
<div id="container">
    ...
    <section id="invoice-title-number">
        <span id="title" class="description">@lang('modules.lead.proposal')</span>
        ...
        @if (count($proposal->items) > 0)
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    @endif
                    <th class="description">{{ isset($proposal->unit) ? $proposal->unit->unit_type : 'Qty\hrs' }}</th>
                ...
                <tr data-iterate="item">
                    ...
                    <td>
                        <div class="mb-3 description">{{ ucfirst($item->item_name) }}</div>
