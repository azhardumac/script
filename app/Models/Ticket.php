...
class Ticket extends BaseModel
{
    ...
    public function badge()
    {
        ...
        if ($totalReply > 1 && $latestReplyUser && $latestReplyUser->id !== user()->id) {
            return '<p class="mb-0"><span class="badge badge-secondary mr-1 bg-info">' . __('app.newResponse') . '</span></p>';
        }

        return $totalReply == 1 ? '<p class="mb-0"><span class="badge badge-secondary mr-1 bg-dark-green">' . __('app.new') . '</span></p>' : '';
    }
