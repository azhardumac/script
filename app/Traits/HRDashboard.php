    ...
    public function headCountChart()
    {
        ...
        foreach($period as $periodData){
            $months[$periodData->format('m-Y')] = [
                'y' => $periodData ? __('app.'.strtolower($periodData->format('F'))) : null,
                'a' => 0
            ];
        }
